...
exports.patchDishRoute = patchDishRoute;
const userMiddleware_1 = require("../../middlewares/userMiddleware");
const patchDishController_1 = require("../../controllers/dishControllers/patchDishController");
...
const patchDishController = new patchDishController_1.PatchDishController(service);
function patchDishRoute(router) {
    router.patch("/v1/dish/:id", new userMiddleware_1.UserMiddleware().run, (0, requireRoleMiddleware_1.requireRole)(["OWNER"]), patchDishController.run.bind(patchDishController));
}
//# sourceMappingURL=patchDish.js.map